...
export default function RefundPolicyPage() {
  ...
  const sections = [
    { title: "1. Eligibility for Refund", content: PlaceholderText },
    { title: "2. Refund Process", content: PlaceholderText },
    { title: "3. Non-refundable Items/Services", content: ShortPlaceholder },
    { title: "4. Exchanges (if applicable)", content: PlaceholderText },
    { title: "5. Changes to This Policy", content: "We may update this Refund & Return Policy from time to time. We will notify you of any changes by posting the new policy on this page. You are advised to review this policy periodically for any changes. Changes to this policy are effective when they are posted on this page." },
    { title: "6. Contacting Us About Refunds", content: "If you have any questions about our Refund Policy, please contact us:\n- By email: support@example.com\n- By visiting this page on our website: [Your Contact Page Link]\n- By phone number: [Your Phone Number]" }
  ];
